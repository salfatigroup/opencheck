...
export class AgentFactory {
  ...
  static buildSystemPrompt(testCase: string, baseUrl: string): string {
    return [
      ...
      "- Prefer browser_evaluate with JavaScript to check for specific elements, text, or loading states",
      ...
      "- After navigation or actions that trigger loading, use browser_evaluate to poll for specific",
      "  conditions instead of taking repeated full-page snapshots.",
      "",
      "Instructions:",
